    ...
    <div class="max-w-5xl mx-auto">
        ...
        <div class="mb-8">
            ...
            <p class="mt-2 text-gray-500 text-lg">
                Factura {{ $cuenta->numero_factura }} - {{ $cuenta->cliente->nombre ?? 'Sin cliente' }}
            </p>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="observacion"
                                  rows="3"
                                  class="w-full px-5 py-4 rounded-2xl border border-gray-300 bg-gray-50 focus:bg-white focus:border-[#c62828] focus:ring-2 focus:ring-[#c62828]/20 outline-none transition">{{ old('observacion') }}</textarea>
                    </div>
