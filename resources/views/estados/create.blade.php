<x-app-layout>
    <div class="max-w-3xl mx-auto">
        <h1 class="text-4xl font-extrabold text-[#1f2937] mb-8">Nuevo Estado</h1>
        ...
        <div class="bg-white rounded-[2rem] shadow-lg border border-gray-100 p-10">
            <form method="POST" action="{{ route('estados.store') }}">
                ...
                <div class="mt-8 flex justify-end space-x-4">
                    ...
                    <button type="submit" class="bg-[#c62828] hover:bg-red-700 text-white px-8 py-3 rounded-xl font-bold shadow-md transition">Guardar</button>
                </div>
            </form>
        </div>
    </div>
