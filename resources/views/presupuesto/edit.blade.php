    ...
    <div class="max-w-5xl mx-auto">
        ...
        <div class="mb-8">
            ...
            <p class="mt-2 text-gray-500 text-lg">
                Actualiza el presupuesto registrado
            </p>
        </div>

        @if ($errors->any())
            <div class="mb-6 bg-red-100 border border-red-300 text-red-700 px-6 py-4 rounded-2xl font-semibold">
                <p class="font-bold mb-2">No se pudo actualizar el presupuesto:</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="mes"
                            ...
                            @foreach(range(1, 12) as $mes)
                                <option value="{{ $mes }}" {{ old('mes', $presupuesto->mes) == $mes ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <select name="categoria_gasto_id"
                            ...
                            @foreach($categorias as $categoria)
                                <option value="{{ $categoria->id }}" {{ old('categoria_gasto_id', $presupuesto->categoria_gasto_id) == $categoria->id ? 'selected' : '' }}>
                                    {{ $categoria->nombre }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="descripcion"
                                  rows="3"
                                  class="w-full px-5 py-4 rounded-2xl border border-gray-300 bg-gray-50 focus:bg-white focus:border-[#c62828] focus:ring-2 focus:ring-[#c62828]/20 outline-none transition">{{ old('descripcion', $presupuesto->descripcion) }}</textarea>
                    </div>
