    ...
    <div class="max-w-5xl mx-auto">
        ...
        <div class="mb-8">
            ...
            <p class="mt-2 text-gray-700 text-lg">
                Actualiza la información del ingreso {{ $ingreso->referencia_ingreso }}
            </p>
        </div>

        @if ($errors->any())
            <div class="mb-6 bg-red-100 border border-red-300 text-red-700 px-6 py-4 rounded-2xl font-semibold">
                <p class="font-bold mb-2">No se pudo actualizar el ingreso:</p>
        ...
        <div class="bg-white rounded-[2rem] shadow-lg border border-gray-200 overflow-hidden">
            ...
            <form action="{{ route('ingresos.update', [$ingreso->referencia_ingreso, $ingreso->fecha, $ingreso->usuario_id]) }}"
                  method="POST"
                  class="p-8">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text"
                               name="origen"
                               value="{{ old('origen', $ingreso->origen) }}"
                    ...
                    <div>
                        ...
                        <select name="metodo_pago_id"
                            ...
                            @foreach($metodosPago as $metodo)
                                <option value="{{ $metodo->id }}" {{ old('metodo_pago_id', $ingreso->metodo_pago_id) == $metodo->id ? 'selected' : '' }}>
                                    {{ $metodo->nombre }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <select name="cuenta_bancaria_id"
                                class="w-full px-5 py-4 rounded-2xl border border-gray-300 bg-gray-50 focus:bg-white focus:border-[#b71c1c] focus:ring-2 focus:ring-[#b71c1c]/20 outline-none transition">
                            <option value="">No aplica para ingresos en efectivo</option>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="descripcion"
                                  rows="3"
                                  class="w-full px-5 py-4 rounded-2xl border border-gray-300 bg-gray-50 focus:bg-white focus:border-[#b71c1c] focus:ring-2 focus:ring-[#b71c1c]/20 outline-none transition">{{ old('descripcion', $ingreso->descripcion) }}</textarea>
                    </div>
