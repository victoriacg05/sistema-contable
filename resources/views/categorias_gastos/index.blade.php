    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                ...
                <p class="mt-2 text-gray-500 text-lg">Administración de categorías para clasificar gastos</p>
            </div>
        ...
        <div class="bg-white rounded-[2rem] shadow-lg border border-gray-100 overflow-hidden">
            <table class="w-full">
                ...
                <tbody>
                    ...
                    @empty
                        <tr><td colspan="3" class="px-6 py-10 text-center text-gray-400">No hay categorías registradas.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
