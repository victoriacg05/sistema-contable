                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="descripcion" rows="3"
                                  class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-[#c62828] focus:border-transparent">{{ old('descripcion', $categoria->descripcion) }}</textarea>
                    </div>
                </div>
